...
use wash_runtime::plugin::surrealdb::{Auth as SurrealdbAuth, SurrealdbConfig, WasiSurrealdb};
...
pub struct HostCommand {
    ...
    #[cfg(feature = "wasi-surrealdb")]
    #[clap(
        long = "surrealdb-namespace",
        env = "SURREALDB_NAMESPACE",
        default_value = "test"
    )]
    ...
    #[cfg(feature = "wasi-surrealdb")]
    #[clap(
        long = "surrealdb-database",
        env = "SURREALDB_DATABASE",
        default_value = "test"
    )]
